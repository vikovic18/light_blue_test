...
class PropertyOwnerDashboardScreen extends StatefulWidget {
  const PropertyOwnerDashboardScreen({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return SafeArea(
        child: Scaffold(
            ...
            drawer: DashboardMenuDraweritem(name: "Hello, Hudson", title: "Property owner", imagePath: ImageConstant.imgEllipse790x90),
            body: SizedBox(
              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    SizedBox(height: 6.v),
                    CustomProfileWidget(name: "Hudson", location: "Cambridge, United Kingdom", imagePath: ImageConstant.imgEllipse790x90),
